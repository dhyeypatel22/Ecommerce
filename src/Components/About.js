    ...
    <Navbar />
      ...
      <section id="about-head" className="section-p1">
        ...
        <div>
          <h2>Who We Are?</h2>
          <p>
            Basil is wellknown brand providing quality products at lowest price.
            Basil works with the vision of offering Luxurious designed clothing.
            Our website is designed to bridge the vast gap between the virtual
            and the physical world. At Basil cloths are not a product, but
            rather, a manifestation of artistry and this is why we are a brand
            that has the distinct honor of being coveted by men &amp; women with
            designs that capture the beauty and celebration of special occasions
            in the life of them.
          </p>
          <abbr title="">
