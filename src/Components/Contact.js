...
<section id="form-details">
  <form action="https://formsubmit.co/pateldhyeyh@gmail.com" method="POST">
  ...
  <div>
    ...
    <p>
      <span>Dhyey Patel</span> Senior Marketing Manager <br /> Phone: + 000 123
      000 511 <br /> Email: pateldhyey@gmail.com{" "}
    </p>
  </div>
  <div>
    <img src={require("../img2/d$1.png")} alt="not found" />
    <p>
      <span>Supreme Patel</span> Senior Operations Manager <br /> Phone: + 000
      456 000 814 <br /> Email: supremeorg@gmail.com{" "}
    </p>
  </div>
  <div>
    <img src={require("../img2/oie_png (1).png")} alt="not found" />
    <p>
      <span>Danny Patel</span> Senior Purchasing Manager <br /> Phone: + 000 789
      000 120 <br /> Email: dannyhere@gmail.com{" "}
    </p>
  </div>
</div>
